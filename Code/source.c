...
//    int visited[MAXV] = {0};    // mark visited
    ...
    if (path_length == 0) {
        ...
        (*my_path_length) = 0;
        my_path = (path_info *) malloc(sizeof(path_info) * 100);
